...
class Geant4Data(BundlePackage):
    ...
    # geant4@9.6.4
    depends_on("g4ndl@4.2", when='@9.6.4')
    depends_on("g4emlow@6.32", when='@9.6.4')

    depends_on("g4photonevaporation@2.3", when='@9.6.4')

    depends_on("g4radioactivedecay@3.6", when='@9.6.4')

    depends_on("g4neutronxs@1.2", when='@9.6.4')
    depends_on("g4pii@1.3", when='@9.6.4')
    depends_on("g4realsurface@1.0", when='@9.6.4')
    depends_on("g4saiddata@1.1", when='@9.6.4')
